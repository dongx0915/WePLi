...
class PanelRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        panel.add(label);
        if(isSelected) panel.setBackground(new Color(169,230,255,255));
...
public class SearchFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchNavbarLabel.setPreferredSize(new java.awt.Dimension(912, 74));
        ...
        backgroundPanel.add(searchButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 90, -1, -1));
